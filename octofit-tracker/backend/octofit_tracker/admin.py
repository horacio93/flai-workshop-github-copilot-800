...
class LeaderboardAdmin(admin.ModelAdmin):
    list_display = ['user_id', 'team_id', 'total_calories', 'total_activities', 'rank', 'updated_at']
...
class WorkoutAdmin(admin.ModelAdmin):
    list_display = ['name', 'exercise_type', 'difficulty_level', 'estimated_duration', 'estimated_calories']
